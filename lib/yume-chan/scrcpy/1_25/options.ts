...
import { ScrcpyDeviceMessageParsers } from "../base/index";
import type {
...
import type { Init } from "./impl/index";
import {
    AckClipboardHandler,
    ClipboardStream,
    ControlMessageTypes,
    ...
    implements ScrcpyOptions<Init>, ScrcpyOptionsListEncoders
{
    ...
    constructor(init: Init) {
        this.value = { ...Defaults, ...init } as unknown as Required<Init>;
    ...
    serialize(): string[] {
        return serialize(this.value, Defaults as unknown as Required<Init>);
    }
