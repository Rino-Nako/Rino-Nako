...
import type { AdbPacketData, AdbPacketInit } from "./packet";
import { AdbCommand, calculateChecksum } from "./packet";
import { AdbDaemonSocketController } from "./socket";
                    ...
                    write: async (
                        ...
                        switch (packet.command) {
                            ...
                            case AdbCommand.Auth:
                                // Ignore stray AUTH packets that might appear after connection
                                // or due to race conditions in handshake
                                break;
                            default:
